...
The plugin is written to `src/Flare/bin/Release/net481/Flare.dll`. To test it, close Valheim and copy the DLL into `BepInEx/plugins/NorskIT-Flare/` in your game installation or mod manager profile. Builds do not install or launch the game.
...
When changing the release version, update both `Flare.csproj` and `Plugin.Version`, and add a changelog entry. For forks, update README image links to your own repository as appropriate. Describe the behavior change and how you tested it in your pull request.
